...
class Student{
  ...
  int[] coursesPKs%\tikz[style=Target, anchor=base]{\node (cpk) {}}%;
}
...
class Course{
  ...
  int[] studentsPKs%\tikz[style=Target, anchor=base]{\node (spk) {}}%;
}
\end{lstlisting}
%\onslide<1>{\caption{Smart Contracts in Hyperledger Java}}
\end{subfigure}
...
\node[Text, below=0.5cm of sr, xshift=-0.1cm] {Cyclic reference causes\\ infinite serialization.};
}

\onslide<3->{
\node[Text, above=2cm of cpk] (cpk-ex) {Replace object refrence to PK reference};
...
\onslide<3-5>{
\node (r11) [align=left, right=0.1cm of m1] {nonce:0x478ad\\ \texttt{\{id:23, name:"Target"\}}};
\node (r12) [align=left, right=0.1cm of m2] {nonce:0x13a63\\ \texttt{\{id:22, name:"Ralphs"\}}};
\node (r13) [align=left, right=0.1cm of m3] {nonce:0x84d3f\\ \texttt{\{id:24, name:"Bestbuy"\}}};
}
\onslide<4>{
...
\onslide<6->{
\node (r21) [align=left, right=0.1cm of m1] {nonce:0xb6c81\\ \texttt{\{id:21, name:"Whole Foods"\}}};
\node (r22) [align=left, right=0.1cm of m2] {nonce:0xb6c81\\ \texttt{\{id:21, name:"Whole Foods"\}}};
\node (r23) [align=left, right=0.1cm of m3] {nonce:0xb6c81\\ \texttt{\{id:21, name:"Whole Foods"\}}};
}
\onslide<7->{
...
\item on-chain
\item pBFT
\item 3200 tx/s in HF 1.2~\cite{gorenflo2020fastfabric}
\end{itemize}
}
