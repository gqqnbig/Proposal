...
In Bitcoin, miners get rewards through mining. In order to move assets from one address to another, like assigning a value from variable to another, the caller (trader) must pay a network fee.
